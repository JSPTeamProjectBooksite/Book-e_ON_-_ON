...
public class DetailPageController extends HttpServlet {
	...
	private List<BookDTO> dao() {
		...
		booklist.add(new BookDTO(1, "기분이 태도가 되지 않으려면", "source/book/기분이_태도가_되지_않으려면.png", "나겨울", "떠오름(RISE)", 13500,
		...
		booklist.add(new BookDTO(2, "노인과 바다", "source/book/노인과_바다.png", "어니스트 헤밍웨이", "민음사", 8000,
		...
		booklist.add(new BookDTO(3, "밥을 왜먹냐 코딩만해도 배부른데", "source/book/밥을_왜먹냐_코딩만해도_배부른데.png", "코딩쟁이", "코딩충 집합소", 18500,
				"<b><span style='color: green; font-size: 15px'>[On & On 독점 도서]</span><br>배불러지는 코딩 습관<b>",
				"<p><h3>대충 설명글</h3></p>"));

		booklist.add(new BookDTO(4, "아몬드", "source/book/아몬드.png", "손원평", "창비", 12000, "<br>" + "<b>아! 몬.드. 넥스트 레.벨.<b>",
		...
		booklist.add(new BookDTO(5, "밥처먹고 코딩만 하기1", "source/book/밥처먹고_코딩만_하기1.png", "코딩에 미친놈", "코딩충 집합소", 14500,
				"<b><span style='color: green; font-size: 15px'>[On & On 독점 도서]</span><br>최고의 다이어트는 코딩?!<b>",
				"<p><h3>(대충 코딩만 한다는 내용)</h3></p><br>" + "설명<br>"));
		booklist.add(new BookDTO(6, "밥처먹고 코딩만 하기2", "source/book/밥처먹고_코딩만_하기2.png", "코딩에 미친놈", "코딩충 집합소", 15000,
				"<b><span style='color: green; font-size: 15px'>[On & On 독점 도서]</span><br>이게 어떻게 2권 나옴?!<b>",
				"<p><h3>(대충 코딩만 한다는 내용)</h3></p><br>" + "설명<br>"));
		booklist.add(new BookDTO(7, "죽고 싶지만 떡볶이는 먹고 싶어", "source/book/죽고_싶지만_떡볶이는_먹고_싶어.png", "백세희", "흔", 13800,
				"<br>" + "<b>그냥 죽어<b>",
		...
		booklist.add(new BookDTO(8, "창문넘어 도망친 100세 노인", "source/book/창문넘어_도망친_100세_노인.png", "요나스 요나손", "열린책들", 16800,
				"<br>" + "<b>요나스 요나손 장편소설<b>",
		...
		booklist.add(new BookDTO(9, "하루도 쉬운 날이 없어", "source/book/하루도_쉬운_날이_없어.png", "소시민 J", "로그인", 16000,
