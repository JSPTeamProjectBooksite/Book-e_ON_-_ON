	...
	<div id="wrap">
		...
		<div id="contents">
			...
			<form action="/payment.do" method="post" id="paymentForm">
					...
					<tr>
						<td class="prodinfo">
							<table>
								<c:forEach var="prod" items="${ prodinfo }" varStatus="status">
									<tr>
										<td class="imgBox"><input type="hidden" name="bookId"
											value="${ prod.id }"> <input type="hidden"
											name="selectCount" value="${ selectCount[status.index] }">
											<img src="${ prod.coverImg }"></td>
						...
						<td rowspan="4" class="stickyBar">
							<table class="stickyTable">
								...
								<tr>
									<th>배송비</th>
									<td><span id="delivery">0</span> 원</td>
								</tr>
								<tr>
									<th>쿠폰할인</th>
								...
								<tr>
									<th>최종결제금액</th>
									<td style="font-size: x-large; color: red;"><span
										class="finalPrice">0</span> 원</td>
								</tr>
							</table>
						</td>
					...
					<tr>
						<td class="point">
							...
							<table>
								...
								<tr>
									<th>적립금 적용</th>
									<td><input type="number" id="userPoint" name="point"
										value="0" readonly disabled>
										<button type="button" name="useBnt" style="text-align: center"
											onclick="return usePoint()">모두사용</button> <br> <small>사용가능
											적립금 <span id="availablePoint">0</span> 원
									</small></td>
								</tr>
							</table>
						</td>
					...
					<tr>
						<td class="paymethod">
							...
							<table>
								<tr>
									<th>결제수단 선택</th>
									<td><label class="paybnt"> <input type="radio"
											name="paymentMethod" value="Visa 카드 결제"> <span><img
												src="/source/ico/Visa_ci.png"></span>
									</label> <label class="paybnt"> <input type="radio"
											name="paymentMethod" value="카카오 페이 결제"> <span><img
												src="/source/ico/Kakaopay_ci.png"></span>
									</label> <label class="paybnt"> <input type="radio"
											name="paymentMethod" value="토스 결제"> <span><img
												src="/source/ico/Toss_ci.png"></span>
									</label></td>
								</tr>
							</table>
						</td>
					...
					<tr>
						<td class="policy">
							<table>
								<tr>
									<td>
										<h3>결제 진행 필수 전체 동의</h3> <input type="checkbox" name="전체동의"
										id="allCheckBox" onclick="allCheck(this)" /> 결제 진행 필수 전체 동의<br>
										<input type="checkbox" name="세부동의" onclick="check(this)" />
										(필수) 개인정보 수집‧이용 및 처리 동의<br> <input type="checkbox"
										name="세부동의" onclick="check(this)" /> (필수) 개인정보 제3자 제공동의<br>
										<input type="checkbox" name="세부동의" onclick="check(this)" />
				...
				<input type="hidden" id="deliveryTotalPointFinal" name="DTPF"
					value="">
