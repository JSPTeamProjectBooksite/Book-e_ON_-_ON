		...
		<form name="inquireFrm" method="post" action="/UserInquiryWrite.do"
			...
			<table class="CustomerInquiry" border="1">
				...
				<tr>
					...
					<td colspan="3"><select style="height: 45px; width: 100%;"
						name="category">
				...
				<tr>
					...
					<tr>
						...
						<td colspan="3">
						<textarea style="border: none; font-size: 15px;" name="content"
								placeholder="&#13;&#10;문의유형을 선택 후 자세하게 작성해주세요.
							&#13;&#10;자세한 내용과 함께 보내주시면 더욱 신속하게 답변 드리겠습니다!"></textarea>
					</td>
				</tr>
				<tr>
					<td colspan="3" ;class="notice"><small><br> *문의내용 답변 안내*</p>
							<br>- 1:1 문의 건의 답변 내용은 홈페이지 상단 마이페이지 내 1:1문의에서 확인 가능합니다.</p>
							<br>- 1:1 문의 건 중 17시 이후 문의 건은 다음 운영시간(평일 09시~ 17시)에 순차적으로 답변드립니다.</p>
							<br>- 상기 운영시간은 정상근무일 기준이며, 휴일인 경우 다음 정상 근무 일에 진행 됩니다.</p>
							<br>- 설/추석/공휴일 등 연휴 기간 동안 고객센터 휴무로 인해 1:1 상담 답변이 불가합니다.</p>
							<br>- 설/추석/공휴일 연휴 끝난 이후부터 순차적으로 답변드릴 예정이오니 양해 부탁드립니다.</p>
					</small></td>
				</tr>
			</table>
			<div class="bnt">
