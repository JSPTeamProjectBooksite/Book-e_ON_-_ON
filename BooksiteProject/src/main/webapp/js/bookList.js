const bookList = [
    ...
    //     author: "저자",
    //     prise: 12345, //가격 정가
    //     image: "source/book/(제목).png", //이미지경로
    //     stack: 999, //제고
    //     publisher: "출판사",
    //     ad: "짧은 소개",
    //     introduce: "장문 소개" 
    // },
    {
        ...
        author: "나겨울",
        prise: 13500,
        image: "source/book/기분이_태도가_되지_않으려면.png",
        stack: 100,
        publisher: "떠오름(RISE)",
        ad: "<br>"+"<b>감정 기복이 심한 당신에게 필요한 기분 수업<b>",
        introduce: "<p><h3>‘남들 챙기느라 정작 나를 사랑하는 법을<br>잊어버린 당신에게 바치는 따뜻한 감정 수업’</h3></p><br>"+
    ...
    },
    {
        ...
        author: "어니스트 헤밍웨이",
        prise: 8000,
        image: "source/book/노인과_바다.png",
        stack: 100,
        publisher: "민음사",
        ad: "<br>"+"<b>세계문학전집<b>",
        introduce: "<p><h3>먼 바다에서 펼쳐지는 노인의 고독한 사투!</h3></p><br>"+
    ...
    {
        BID: 2,
        title: "밥을 왜먹냐 코딩만해도 배부른데",
        author: "코딩쟁이",
        prise: 18500,
        image: "source/book/밥을_왜먹냐_코딩만해도_배부른데.png",
        stack: 100,
        publisher: "코딩충 집합소",
        ad: "<b><span style='color: green; font-size: 15px'>[On & On 독점 도서]</span><br>배불러지는 코딩 습관<b>",
        introduce: "<p><h3>대충 설명글</h3></p>" 
    },
    {
        BID: 3,
        title: "아몬드",
        author: "손원평",
        prise: 12000,
        image: "source/book/아몬드.png",
        stack: 100,
        publisher: "창비",
        ad: "<br>"+"<b>아! 몬.드. 넥스트 레.벨.<b>",
        introduce: "<p><h3>괴물인 내가 또 다른 괴물을 만났다!</h3></p><br>"+
    ...
    },
    {
        ...
        author: "코딩에 미친놈",
        prise: 14500,
        image: "source/book/밥처먹고_코딩만_하기1.png",
        stack: 100,
        publisher: "코딩충 집합소",
        ad: "<b><span style='color: green; font-size: 15px'>[On & On 독점 도서]</span><br>최고의 다이어트는 코딩?!<b>",
        introduce: "<p><h3>(대충 코딩만 한다는 내용)</h3></p><br>"+
        "설명<br>"
    },
    {
        BID: 5,
        ...
        author: "코딩에 미친놈",
        prise: 15000,
        image: "source/book/밥처먹고_코딩만_하기2.png",
        stack: 100,
        publisher: "코딩충 집합소",
        ad: "<b><span style='color: green; font-size: 15px'>[On & On 독점 도서]</span><br>이게 어떻게 2권 나옴?!<b>",
        introduce: "<p><h3>(대충 코딩만 한다는 내용)</h3></p><br>"+
        "설명<br>"
    },
    {
        ...
        author: "백세희",
        prise: 13800,
        image: "source/book/죽고_싶지만_떡볶이는_먹고_싶어.png",
        stack: 100,
        publisher: "흔",
        ad: "<br>"+"<b>그냥 죽어<b>",
        introduce: "<p><h3>의심 없이 편안하게 사랑하고 사랑받고 싶은 한 사람의 이야기</h3></p><br>"+
    ...
    },
    {
        ...
        author: "요나스 요나손",
        prise: 16800,
        image: "source/book/창문넘어_도망친_100세_노인.png",
        stack: 100,
        publisher: "열린책들",
        ad: "<br>"+"<b>요나스 요나손 장편소설<b>",
        introduce: "<p><h3>세계 역사를 뒤바꾼 영감님의 모험!</h3></p><br>"+
    ...
    },
    {
        ...
        author: "소시민 J",
        prise: 16000,
        image: "source/book/하루도_쉬운_날이_없어.png",
        stack: 100,
        publisher: "로그인",
        ad: "<br>"+"<b>N년차 모 자치구 공무원의 오늘도 평화로운 민원창구<b>",
        introduce: "<p><h3>공무원의,<br>공무원에 의한,<br>그러나 공무원만을 위한 것은 아닌 우리 모두의 이야기</h3></p><br>"+
